  ...
  return (
    <NextUINavbar maxWidth="full" position="sticky">
      ...
      <NavbarContent className="sm:hidden basis-1 pl-4" justify="end">
        <Link isExternal href={siteConfig.links.github} className="transition-transform duration-300 hover:scale-110">
          <GithubIcon className="text-default-500" />
        </Link>
        <Link isExternal href={siteConfig.links.website} className="transition-transform duration-300 hover:scale-110">
          <WebsiteIcon className="text-default-500" />
        </Link>
        <NavbarMenuToggle />
      </NavbarContent>
