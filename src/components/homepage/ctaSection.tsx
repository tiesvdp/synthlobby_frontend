...
export function CtaSection() {
  ...
  return (
    <section className="w-full py-20 text-center relative bg-gradient-to-b from-white to-purple-50">
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          Ready to find your <span className="text-[#c026d3]">perfect synth?</span>
        </motion.h2>
        <motion.p
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
